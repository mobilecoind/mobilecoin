...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "mobilecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    //{"mobilecointools.com", "dnsseed.mobilecointools.com"},
    //{"mobilecoinpool.org", "dnsseed.mobilecoinpool.org"},
    //{"xurious.com", "dnsseed.ltc.xurious.com"},
    //{"koin-project.com", "dnsseed.koin-project.com"},
    {"lion-coin.org", "dnsseed.lion-coin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"mobilecointools.com", "testnet-seed.mobilecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. mobilecoin is probably already running."), addrBind.ToString().c_str());
        else
